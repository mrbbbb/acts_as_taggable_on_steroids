...
Rails 2.*
  ...
  ruby script/plugin install git://github.com/mrbbbb/acts_as_taggable_on_steroids.git

Rails 3:

  rails plugin install git://github.com/mrbbbb/acts_as_taggable_on_steroids.git
